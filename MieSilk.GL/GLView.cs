...
namespace Mie.Silk.OpenGL
{
    public class GLView : ISilkView
    {
        ...
        #endregion
        //常态零件渲染模式
        public int PartRenderType { get; set; } = 3;
        //相机
        public OrthoCamera Camera { get; set; }
        public CameraController controller { get; set; } = new CameraController();
        public GLView() { }
        public void Init()
        {
        ...
        private void OnLoad()
        {
            ...
            #endregion
            #region 初步HBeam测试区域
            RenderTarget = GLBReader.Convert("data.glb");
            ...
            //RenderTarget = TestCylinder.GetCylineders_32Sides(1, 1, 1);cd
            ...
            BoltTarget = new SolidGeometry3D();
